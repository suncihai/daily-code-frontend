...
/* harmony import */ var _common_js_const__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../common/js/const */ "./common/js/const.js");
...
/* harmony import */ var classname__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! classname */ "classname");
/* harmony import */ var classname__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(classname__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _AddRecord__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./AddRecord */ "./components/code/AddRecord.js");
/* harmony import */ var _assets_img_java_png__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../assets/img/java.png */ "./assets/img/java.png");
/* harmony import */ var _assets_img_java_png__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_assets_img_java_png__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _assets_img_javascript_png__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../assets/img/javascript.png */ "./assets/img/javascript.png");
/* harmony import */ var _assets_img_javascript_png__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_assets_img_javascript_png__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../assets/img/java_fail.png */ "./assets/img/java_fail.png");
/* harmony import */ var _assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(_assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_22__);
/* harmony import */ var _assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../assets/img/javascript_fail.png */ "./assets/img/javascript_fail.png");
/* harmony import */ var _assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(_assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_23__);
/* harmony import */ var _common_css_constant__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../common/css/constant */ "./common/css/constant.js");
...
})(["tr td{text-align:left;padding:0 5px;img{height:24px;}}tr.fail{color:#fd9700;}"]);
...
function (_React$Component) {
  ...
  function CalendarWrap() {
      ...
      arr.map(function (list) {
        if (list.length > 0) {
          list.map(function (ele) {
            ele.name = _common_js_const__WEBPACK_IMPORTED_MODULE_14__["problemList"][ele.problem - 1];
          });
        }
      });
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "dateFullCellRender", function (value, arr, month) {
      ...
      if (cell) {
        var cellStyle = classname__WEBPACK_IMPORTED_MODULE_18___default()({
        ...
        if (cell.count > 0) {
          var content = react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(PopTable, null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("tbody", null, cell.problems.map(function (ele, index) {
            return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("tr", {
              className: classname__WEBPACK_IMPORTED_MODULE_18___default()({
                fail: ele.success == false
              }),
              key: index
            }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("td", null, ele.problem), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("td", null, ele.name), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("td", null, function () {
              if (ele.language === 'java') {
                if (ele.success === false) {
                  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("img", {
                    src: _assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_22___default.a
                  });
                } else {
                  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("img", {
                    src: _assets_img_java_png__WEBPACK_IMPORTED_MODULE_20___default.a
                  });
                }
              } else {
                if (ele.success == false) {
                  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("img", {
                    src: _assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_23___default.a
                  });
                } else {
                  return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("img", {
                    src: _assets_img_javascript_png__WEBPACK_IMPORTED_MODULE_21___default.a
                  });
                }
              }
            }()));
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(Body, null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(antd_lib_spin__WEBPACK_IMPORTED_MODULE_1___default.a, {
        ...
        dateFullCellRender: function dateFullCellRender(value) {
          return _this4.dateFullCellRender(value, records.prevMonthRecord, moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(2, 'months').startOf('month').format('M'));
        },
        value: moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(2, 'months').startOf('month'),
        fullscreen: false,
        headerRender: function headerRender() {
          return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
            className: "month"
          }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(2 + 3 * (page - 1), 'months').startOf('month').format('YYYY, MMM')), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
            className: "records"
        ...
        dateFullCellRender: function dateFullCellRender(value) {
          return _this4.dateFullCellRender(value, records.lastMonthRecord, moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(1, 'months').startOf('month').format('M'));
        },
        value: moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(1, 'months').startOf('month'),
        fullscreen: false,
        headerRender: function headerRender() {
          return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
            className: "month"
          }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(1 + 3 * (page - 1), 'months').startOf('month').format('YYYY, MMM')), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
            className: "records"
          }, records.lastMonthCount));
        }
      })), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(CalendarBox, null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(antd_lib_calendar__WEBPACK_IMPORTED_MODULE_3___default.a, {
        dateFullCellRender: function dateFullCellRender(value) {
          return _this4.dateFullCellRender(value, records.currMonthRecord, moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(0, 'months').startOf('month').format('M'));
        },
        fullscreen: false,
        headerRender: function headerRender() {
          return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
            className: "month"
          }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", null, moment__WEBPACK_IMPORTED_MODULE_17___default()().subtract(0 + 3 * (page - 1), 'months').startOf('month').format('YYYY, MMM')), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("div", {
            className: "records"
          }, records.currMonthCount));
        }
      })))), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(_AddRecord__WEBPACK_IMPORTED_MODULE_19__["default"], {
...
var mapDispatchToProps = {
  getRecords: _store__WEBPACK_IMPORTED_MODULE_16__["getRecords"]
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_15__["connect"])(mapStateToProps, mapDispatchToProps)(CalendarWrap));
