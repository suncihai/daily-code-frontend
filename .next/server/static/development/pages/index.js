...
/* harmony import */ var _assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../assets/img/java_fail.png */ "./assets/img/java_fail.png");
/* harmony import */ var _assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(_assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_20__);
/* harmony import */ var _assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../assets/img/javascript_fail.png */ "./assets/img/javascript_fail.png");
/* harmony import */ var _assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(_assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _common_css_constant__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../common/css/constant */ "./common/css/constant.js");
...
})(["display:inline-block;width:350px;border:1px solid #d9d9d9;border-radius:4px;.ant-fullcalendar-last-month-cell,.ant-fullcalendar-next-month-btn-day{color:#ccc;}.ant-fullcalendar-selected-day .ant-fullcalendar-value{background:transparent;color:rgba(0,0,0,0.65);box-shadow:none;}.ant-fullcalendar-today .ant-fullcalendar-value{box-shadow:none;}.month{padding:10px;text-align:center;position:relative;.records{position:absolute;right:10px;top:5px;color:#fff;background:", ";padding:5px;border-radius:50px;}}table{tr{td{.case1{border-radius:5px;background:#cce28c;}.case2{border-radius:5px;background:#6abb03;color:#fff;}.case3{border-radius:5px;background:#287d20;color:#fff;position:relative;overflow:hidden;&:after{animation:shine 5s ease-in-out infinite;animation-fill-mode:forwards;content:\"\";position:absolute;top:-110%;left:-210%;width:200%;height:200%;opacity:0;transform:rotate(30deg);background:rgba(255,255,255,0.13);background:linear-gradient( to right,rgba(255,255,255,0.13) 0%,rgba(255,255,255,0.13) 77%,rgba(255,255,255,0.5) 92%,rgba(255,255,255,0.0) 100% );}&:active:after{opacity:0;}}}}}@keyframes shine{10%{opacity:1;top:-30%;left:-30%;transition-property:left,top,opacity;transition-duration:0.7s,0.7s,0.15s;transition-timing-function:ease;}100%{opacity:0;top:-30%;left:-30%;transition-property:left,top,opacity;}}"], _common_css_constant__WEBPACK_IMPORTED_MODULE_22__["themeColor"]);
        ...
        if (cell.count > 0) {
          var content = react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(PopTable, null, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("tbody", null, cell.problems.map(function (ele, index) {
            return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("tr", {
              className: classname__WEBPACK_IMPORTED_MODULE_16___default()({
              ...
              if (ele.language === 'java') {
                if (ele.success === false) {
                  return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("img", {
                    src: _assets_img_java_fail_png__WEBPACK_IMPORTED_MODULE_20___default.a
                  });
                } else {
                  return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("img", {
                ...
                if (ele.success == false) {
                  return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("img", {
                    src: _assets_img_javascript_fail_png__WEBPACK_IMPORTED_MODULE_21___default.a
                  });
                } else {
                  return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("img", {
