...
class CalendarWrap extends React.Component {
  ...
  dateFullCellRender = (value, arr, month, problems) => {
    ...
    if (cell) {
                      ...
                      {(() => {
                        if (ele.language === 'java') {
                          if (ele.success === false) {
                            return <img src={javafailicon} />;
                          } else {
                            return <img src={javaicon} />;
                          }
                        } else {
                          if (ele.success == false) {
                            return <img src={javascriptfailicon} />;
                          } else {
      ...
      return <DateTd>{value.date()}</DateTd>;
    }
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(CalendarWrap);
